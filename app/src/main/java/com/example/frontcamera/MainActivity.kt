...
class MainActivity : AppCompatActivity() {
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun
                    ...
                    val msg = "Photo capture succeeded" //: ${output.savedUri} saved url
    ...
    private fun triggerScreenBlink() {
        val flashOverlay = findViewById<View>(R.id.flash_overlay)
        ...
        flashOverlay.animate()
            .alpha(0f)
            .setDuration(300) // Adjust the duration for desired blink effect
            .withEndAction {
